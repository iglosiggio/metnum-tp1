...
vector<double> justice::calculateLeaderboard(const int teamQuantity, const int matchesQuantity, const vector<vector<int>> resultMatrix) {
    vector<double> results(teamQuantity, 0.0);
    vector<double> matchesQuantityPerTeam(teamQuantity, 0);
    vector<double> matchesRivals(teamQuantity, 0);
